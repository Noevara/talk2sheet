...
MESSAGES = {
    "en": {
        ...
        "chart_unavailable": "Chart output was downgraded to text because chart rendering failed: {reason}",
    ...
    "zh-CN": {
        ...
        "chart_unavailable": "图表渲染失败，已降级为文本结果：{reason}",
    ...
    "ja-JP": {
        ...
        "chart_unavailable": "チャート描画に失敗したため、テキスト結果にフォールバックしました: {reason}",
